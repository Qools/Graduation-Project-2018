...
#api_key_path = "Users\asus\Desktop\Class 4\2\Graduation Project II\GradProjectFakeNewsDetection\GradProjectFakeNewsDetection\Scraping_Data\NYT_API_KEY.txt"

#with open(api_key_path, 'r') as handle:
API_KEY = 'f49de4d1e740436c91c6d1a59d3d1a24'
#handle.read()
